...
/* configuracion/comprension.twig */
class __TwigTemplate_574c2fbe2d5f1e3b77ed0091b54e668902f29da630c465968fdf2cc8be0d40f8 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("base/base.twig", "configuracion/comprension.twig", 1);
        $this->blocks = array(
    ...
    {
        // line 2
        $context["forms"] = $this->loadTemplate("base/form.twig", "configuracion/comprension.twig", 2);
        // line 1
    ...
    <div class=\"portlet-body form\">
        <div id=\"div-form\">
            ";
        // line 46
        echo $context["forms"]->getform_open("frmcomprension", "frmcomprension");
        echo "
            ";
        // line 47
        ...
        echo "
            ...
            <div class=\"row\">
                <div class=\"col-md-6\">
                    ";
        // line 52
        echo $context["forms"]->getlabel(array("id" => "perfil", "content" => "Comprension"));
        echo "
                    ";
        // line 53
        echo $context["forms"]->getinput_text(array("attr" => array("name" => "comprension", "class" => "form-control", "placeholder" => "Comprension", "data" => array("validate" => "required|max(25)|min(3)", "type" => "alpha", "text" => "upper"))));
        echo "
                </div>
                <div class=\"col-md-6\">
    ...
    <table class=\"table  table-striped table-bordered table-hover table-checkable order-column\" id=\"tcomprension\">
        <thead>
            <tr>
                <th>
                    <label class=\"mt-checkbox mt-checkbox-single mt-checkbox-outline\">
                        <input type=\"checkbox\" class=\"group-checkable\" data-set=\"#tcomprension .checkboxes\"/>
                        <span></span>
                    </label>
                </th>
                <th>#</th>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["lista"]) {
            ...
            echo "</td>
                    <td> ";
            // line 105
            echo twig_escape_filter($this->env, $this->getAttribute($context["lista"], "comprension", array()), "html", null, true);
            echo " </td>
                    <td> ";
            // line 106
...
";
    ...
    public function block_javascript($context, array $blocks = array())
    {
        // line 114
        echo "<script src=\"";
        echo twig_escape_filter($this->env, (public_url() . "script/comprension.js"), "html", null, true);
...
";
    ...
    {
        return "configuracion/comprension.twig";
    }
    ...
    {
        return array (  233 => 114,  230 => 113,  223 => 109,  206 => 106,  202 => 105,  198 => 104,  191 => 100,  182 => 97,  179 => 96,  176 => 95,  173 => 94,  170 => 93,  153 => 92,  132 => 74,  128 => 73,  105 => 53,  101 => 52,  94 => 48,  90 => 47,  86 => 46,  78 => 40,  61 => 13,  56 => 10,  53 => 9,  48 => 6,  42 => 5,  37 => 4,  34 => 3,  30 => 1,  28 => 2,  11 => 1,);
    }
...
{% block content %}
    ...
    <div class=\"portlet-body form\">
        <div id=\"div-form\">
            {{ forms.form_open('frmcomprension', 'frmcomprension') }}
            {{ forms.token(token) }}
            {{ forms.token(token,'token') }}

            <div class=\"row\">
                <div class=\"col-md-6\">
                    {{ forms.label({'id':'perfil', 'content':'Comprension'}) }}
                    {{ forms.input_text({'attr':{'name': 'comprension', 'class':'form-control', 'placeholder':'Comprension','data':{'validate':'required|max(25)|min(3)', 'type':'alpha', 'text':'upper'}}}) }}
                </div>
                <div class=\"col-md-6\">
                    <label for=\"span_small\" class=\"control-label\">Estatus</label>
                    <div class=\"clearfix\">
...
{% endblock %}
{% block javascript %}
<script src=\"{{ public_url()~ 'script/comprension.js' }}\" type=\"text/javascript\" charset=\"utf-8\"></script>
{% endblock %}", "configuracion/comprension.twig", "/var/www/appreactivos/application/views/twig/templates/configuracion/comprension.twig");
    }
}
