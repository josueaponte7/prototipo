...
/* configuracion/conocimiento.twig */
class __TwigTemplate_511e45293fe1920ac5d920cb80304d3352b5d8d97a17137c3b4a9742b1ed93ba extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("base/base.twig", "configuracion/conocimiento.twig", 1);
        $this->blocks = array(
    ...
    {
        // line 2
        $context["forms"] = $this->loadTemplate("base/form.twig", "configuracion/conocimiento.twig", 2);
        // line 1
    ...
    <div class=\"portlet-body form\">
        <div id=\"div-form\">
            ";
        // line 46
        echo $context["forms"]->getform_open("frmconocimiento", "frmconocimiento");
        echo "
            ";
        // line 47
        ...
        echo "
            ...
            <div class=\"row\">
                <div class=\"col-md-6\">
                    ";
        // line 52
        echo $context["forms"]->getlabel(array("id" => "perfil", "content" => "Conocimiento"));
        echo "
                    ";
        // line 53
        echo $context["forms"]->getinput_text(array("attr" => array("name" => "conocimiento", "class" => "form-control", "placeholder" => "Conocimiento", "data" => array("validate" => "required|max(25)|min(3)", "type" => "alpha", "text" => "upper"))));
        echo "
                </div>
                <div class=\"col-md-6\">
    ...
    <table class=\"table  table-striped table-bordered table-hover table-checkable order-column\" id=\"tconocimiento\">
        <thead>
            <tr>
                <th>
                    <label class=\"mt-checkbox mt-checkbox-single mt-checkbox-outline\">
                        <input type=\"checkbox\" class=\"group-checkable\" data-set=\"#tconocimiento .checkboxes\"/>
                        <span></span>
                    </label>
                </th>
                <th>#</th>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["lista"]) {
            ...
            echo "</td>
                    <td> ";
            // line 105
            echo twig_escape_filter($this->env, $this->getAttribute($context["lista"], "conocimiento", array()), "html", null, true);
            echo " </td>
                    <td> ";
            // line 106
...
<script src=\"";
        // line 115
        echo twig_escape_filter($this->env, (public_url() . "script/conocimiento.js"), "html", null, true);
...
";
    ...
    {
        return "configuracion/conocimiento.twig";
    }
...
{% block content %}
    ...
    <div class=\"portlet-body form\">
        <div id=\"div-form\">
            {{ forms.form_open('frmconocimiento', 'frmconocimiento') }}
            {{ forms.token(token) }}
            {{ forms.token(token,'token') }}

            <div class=\"row\">
                <div class=\"col-md-6\">
                    {{ forms.label({'id':'perfil', 'content':'Conocimiento'}) }}
                    {{ forms.input_text({'attr':{'name': 'conocimiento', 'class':'form-control', 'placeholder':'Conocimiento','data':{'validate':'required|max(25)|min(3)', 'type':'alpha', 'text':'upper'}}}) }}
                </div>
                <div class=\"col-md-6\">
                    <label for=\"span_small\" class=\"control-label\">Estatus</label>
                    <div class=\"clearfix\">
...
<script src=\"{{ public_url()~ 'script/conocimiento.js' }}\" type=\"text/javascript\" charset=\"utf-8\"></script>
{% endblock %}", "configuracion/conocimiento.twig", "/var/www/appreactivos/application/views/twig/templates/configuracion/conocimiento.twig");
    }
}
