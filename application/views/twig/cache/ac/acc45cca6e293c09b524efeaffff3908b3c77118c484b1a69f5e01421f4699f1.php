...
/* seguridad/perfil.twig */
class __TwigTemplate_1579d22555df9abd67e72a59c39655c845f816ab83d3ef471454165038ed9fe3 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("base/base.twig", "seguridad/perfil.twig", 1);
        $this->blocks = array(
    ...
    {
        // line 2
        $context["forms"] = $this->loadTemplate("base/form.twig", "seguridad/perfil.twig", 2);
        // line 1
    ...
    <div class=\"portlet-body form\">
        <div id=\"div-form\">
            ";
        // line 46
        echo $context["forms"]->getform_open("frmperfil", "frmperfil");
        echo "
            ";
        // line 47
        ...
        echo "
            ...
            <div class=\"row\">
                <div class=\"col-md-6\">
                    ";
        // line 52
        echo $context["forms"]->getlabel(array("id" => "perfil", "content" => "Perfil"));
        echo "
                    ";
        // line 53
        echo $context["forms"]->getinput_text(array("attr" => array("name" => "perfil", "class" => "form-control", "placeholder" => "Pefil", "data" => array("validate" => "required|max(25)|min(3)", "type" => "alpha", "text" => "upper"))));
        echo "
                </div>
                <div class=\"col-md-6\">
    ...
    <table class=\"table  table-striped table-bordered table-hover table-checkable order-column\" id=\"tperfil\">
        <thead>
            <tr>
                <th>
                    <label class=\"mt-checkbox mt-checkbox-single mt-checkbox-outline\">
                        <input type=\"checkbox\" class=\"group-checkable\" data-set=\"#tperfil .checkboxes\"/>
                        <span></span>
                    </label>
                </th>
                <th>#</th>
...
<script src=\"";
        // line 115
        echo twig_escape_filter($this->env, (public_url() . "script/perfil.js"), "html", null, true);
...
{% block content %}
    ...
    <div class=\"portlet-body form\">
        <div id=\"div-form\">
            {{ forms.form_open('frmperfil', 'frmperfil') }}
            {{ forms.token(token) }}
            {{ forms.token(token,'token') }}

            <div class=\"row\">
                <div class=\"col-md-6\">
                    {{ forms.label({'id':'perfil', 'content':'Perfil'}) }}
                    {{ forms.input_text({'attr':{'name': 'perfil', 'class':'form-control', 'placeholder':'Pefil','data':{'validate':'required|max(25)|min(3)', 'type':'alpha', 'text':'upper'}}}) }}
                </div>
                <div class=\"col-md-6\">
                    <label for=\"span_small\" class=\"control-label\">Estatus</label>
                    <div class=\"clearfix\">
...
<script src=\"{{ public_url()~ 'script/perfil.js' }}\" type=\"text/javascript\" charset=\"utf-8\"></script>
{% endblock %}", "seguridad/perfil.twig", "/var/www/appreactivos/application/views/twig/templates/seguridad/perfil.twig");
    }
}
